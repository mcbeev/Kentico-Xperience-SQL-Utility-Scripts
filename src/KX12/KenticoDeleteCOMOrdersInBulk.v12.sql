/* KenticoDeleteCOMOrdersinBulk.v12.sql       */
...
BEGIN
	...
	SELECT @CustomerID = OrderCustomerID 
	FROM COM_Order
	...
	--Remove the Addresses of the Order
	DELETE FROM COM_OrderAddress WHERE [AddressOrderID] = @OrderID
